...
explainedDT
```
## Correlation between F6 and Lymphocyte doubling time
...
plot_enrichment(res.positive, factor = "Factor1", max.pathways = 20)+ ggtitle("Reactome enrichment F1 (positive weights)")
```
...
plot_enrichment(res.negative, factor = "Factor1", max.pathways = 10)+ ggtitle("Reactome enrichment F1 (negative weights)")
```
...
plot_enrichment(res.positive, factor = "Factor2", max.pathways = 20)+ ggtitle("Reactome enrichment F2 (positive weights)")
```
...
```
```{r,fig.width=10, fig.height=4 }
plot_enrichment(res.negative, factor = "Factor2", max.pathways = 10)+ ggtitle("Reactome enrichment F2 (negative weights)")
```
...
plot_enrichment(res.positive, factor = "Factor3", max.pathways = 20)+ ggtitle("Reactome enrichment F3 (positive weights)")
```
...
plot_enrichment(res.negative, factor = "Factor3", max.pathways = 10)+ ggtitle("Reactome enrichment F3 (negative weights)")
```
...
```
```{r, fig.width=10, fig.height=6 }
plot_enrichment(res.positive, factor = "Factor4", max.pathways = 20)+ ggtitle("Reactome enrichment F4 (positive weights)")
```
...
```
```{r, fig.width=9, fig.height=4}
plot_enrichment(res.negative, factor = "Factor4", max.pathways = 20)+ ggtitle("Reactome enrichment F4 (negative weights)")
```
...
plot_enrichment(res.positive, factor = "Factor6", max.pathways = 20)+ ggtitle("Reactome enrichment F6 (positive weights)")
```
...
```
```{r, fig.width=8, fig.height=4}
plot_enrichment(res.positive, factor = "Factor7", max.pathways = 20)+ ggtitle("Reactome enrichment F7 (positive weights)")
```
...
```
```{r, fig.width=9, fig.height=4 }
plot_enrichment(res.negative, factor = "Factor7", max.pathways = 20)+ ggtitle("Reactome enrichment F7 (negative weights)")
```
...
plot_enrichment(res.positive, factor = "Factor8", max.pathways = 20)+ ggtitle("Reactome enrichment F8 (positive weights)")
```
...
```
```{r, fig.width=13, fig.height=6}
plot_enrichment(res.negative, factor = "Factor8", max.pathways = 20)+ ggtitle("Reactome enrichment F8 (negative weights)")
```
